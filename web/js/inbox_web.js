                              ...
                              for(var i = size - 1 ;i >= lastMailIndex ;i--)
                                  {
                                      ...
                                      data += "<tr id="+mail[i]._id+"><td>"+mail[i]._sender+"</td><th>20-01-2017</td><th>"+mail[i]._subject+"</td><td>"+mail[i]._message+"</td></tr>"
                                  }
          ...
          for(var i = size - 1 ;i >= lastMailIndex ;i--)
              {
                  ...
                  data += "<tr id="+MAIL_LIST[i]._id+"><td>"+MAIL_LIST[i]._sender+"</td><th>20-01-2017</td><th>"+MAIL_LIST[i]._subject+"</td><td>"+MAIL_LIST[i]._message+"</td></tr>"
              }
              lastMailIndex += mailPerPage;
              $("#mail_column").html(data);
          }
